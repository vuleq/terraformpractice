...
const CONFIG = {
  S3_BUCKET_NAME: 'prod-wdr-maritimeapps-deploy-lambda-fe-source6',
  S3_REGION: 'ap-southeast-1',
  API_CLOUDFRONT_DOMAIN: 'dmwji128fkqvu.cloudfront.net',
  COGNITO_REGION: 'ap-southeast-1',
  COGNITO_USER_POOL_ID: 'ap-southeast-18h0zvkqbm',
  S3_ASSETS_BUCKET: 'prod-wdr-maritimeapps-deploy-lambda-assets6',
    ...
    if (objectKey.endsWith('index.html') || request.uri === '/') {
        try {
            ...
            const cspValue = [
                ...
                "object-src 'none'",
                "base-uri 'self'",
                `connect-src 'self' ${connectSrcDomains.join(' ')} data:`,
            ...
            htmlBody = htmlBody.replace(/<app-root/g, `<app-root nonce="${nonce}" data-csp-nonce="${nonce}"`);
